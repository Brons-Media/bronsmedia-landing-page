...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Mediastrategi som tar dig genom mediabruset | Brons Media" },
      {
        name: "description",
        content:
          "Rätt kanaler, rätt budskap, rätt målgrupp. Brons Media bygger mediastrategin som gör att du syns när konkurrensen om uppmärksamheten är stenhård.",
      },
      { property: "og:title", content: "När du igenom mediabruset? | Brons Media" },
      {
        property: "og:description",
        content:
          "Målgruppsanalys, kanalstrategi, budskapsplattform och medieplan med tydliga mål.",
      },
